...
{
    switch (controlType) {
        case UIA_ButtonControlTypeId: return tr("Button");
        case UIA_CheckBoxControlTypeId: return tr("CheckBox");
        case UIA_ComboBoxControlTypeId: return tr("ComboBox");
        case UIA_EditControlTypeId: return tr("Edit");
        case UIA_HyperlinkControlTypeId: return tr("Hyperlink");
        case UIA_ImageControlTypeId: return tr("Image");
        case UIA_ListItemControlTypeId: return tr("ListItem");
        case UIA_ListControlTypeId: return tr("List");
        case UIA_MenuControlTypeId: return tr("Menu");
        case UIA_MenuBarControlTypeId: return tr("MenuBar");
        case UIA_MenuItemControlTypeId: return tr("MenuItem");
        case UIA_ProgressBarControlTypeId: return tr("ProgressBar");
        case UIA_RadioButtonControlTypeId: return tr("RadioButton");
        case UIA_ScrollBarControlTypeId: return tr("ScrollBar");
        case UIA_SliderControlTypeId: return tr("Slider");
        case UIA_SpinnerControlTypeId: return tr("Spinner");
        case UIA_StatusBarControlTypeId: return tr("StatusBar");
        case UIA_TabControlTypeId: return tr("Tab");
        case UIA_TabItemControlTypeId: return tr("TabItem");
        case UIA_TextControlTypeId: return tr("Text");
        case UIA_ToolBarControlTypeId: return tr("ToolBar");
        case UIA_ToolTipControlTypeId: return tr("ToolTip");
        case UIA_TreeControlTypeId: return tr("Tree");
        case UIA_TreeItemControlTypeId: return tr("TreeItem");
        case UIA_CustomControlTypeId: return tr("Custom");
        case UIA_GroupControlTypeId: return tr("Group");
        case UIA_ThumbControlTypeId: return tr("Thumb");
        case UIA_DataGridControlTypeId: return tr("DataGrid");
        case UIA_DataItemControlTypeId: return tr("DataItem");
        case UIA_DocumentControlTypeId: return tr("Document");
        case UIA_SplitButtonControlTypeId: return tr("SplitButton");
        case UIA_WindowControlTypeId: return tr("Window");
        case UIA_PaneControlTypeId: return tr("Pane");
        case UIA_HeaderControlTypeId: return tr("Header");
        case UIA_HeaderItemControlTypeId: return tr("HeaderItem");
        case UIA_TableControlTypeId: return tr("Table");
        case UIA_TitleBarControlTypeId: return tr("TitleBar");
        case UIA_SeparatorControlTypeId: return tr("Separator");
        default: return tr("Unknown(%1)").arg(controlType);
    }
}
